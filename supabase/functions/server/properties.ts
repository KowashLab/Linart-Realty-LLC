...
export async function seedInitialProperties(): Promise<{ success: boolean; total: number; created: number; failed: number; failedItems: string[] }> {
  ...
  const initialProperties = [
    ...
    // ═══════════════════════════════════════════════════════════════
    {
      ...
      images: ['/images/property-waterfront-mansion.jpg', '/images/property-1.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-island-beach-house.jpg', '/images/property-2.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-shopping-plaza.jpg', '/images/investment-building.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-modern-house.jpg', '/images/property-3.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-corporate-headquarters.jpg', '/images/investment-skyline.jpg'],
    ...
    // ═══════════════════════════════════════════════════════════════
    {
      ...
      images: ['/images/property-mediterranean-villa.jpg', '/images/residential-mansion.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-miami-penthouse.jpg', '/images/property-4.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-waterfront-mansion.jpg', '/images/property-5.jpg'],
      mainImage: '/images/property-waterfront-mansion.jpg',
      propertyType: 'Luxury Estates',
    ...
    },
    {
      ...
      images: ['/images/property-1.jpg', '/images/residential-entrance.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-2.jpg', '/images/property-6.jpg'],
    ...
    },
    {
      ...
      images: ['/images/property-3.jpg', '/images/residential-mansion.jpg'],
